...
<html>
<head>
<title>10Transaction/buyTicketMain.jsp</title>
...
<div class="container">
	...
	<h3>트랜젝션 처리해서 티켓 구매하기</h3>
	<h4>제약조건 : check(countNum<5) -> 티켓구매는 4장까지만 가능함</h4>
	
	<form action="buyTicketAction.do" method="post" name="ticketFrm" onsubmit="return buyTicketValidate(this);">
